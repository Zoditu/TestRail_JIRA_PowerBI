...
namespace Gurock.TestRail
{
	public class APIClient
	{
		...
		public Boolean IsTestRail { get; set; }
		...
		{
			this.m_url = IsTestRail ? base_url + "index.php?/api/v2/" : base_url;
			...
			//ConsumerTestRail.Application.Helpers.Logger.Log += "Auth: " + auth + Environment.NewLine;
			...
			//ConsumerTestRail.Application.Helpers.Logger.Log += "Response: " + Environment.NewLine + text + Environment.NewLine;
